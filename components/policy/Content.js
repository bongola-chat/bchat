          ...
          <div className="col-lg-10 offset-lg-1">
            ...
            <div className="text-container">
              ...
              <ol className="li-space-lg">
                ...
                <li>
                  To sell or market Leno Landing Page products and services to
                  you
                </li>
                <li>
            ...
            <div className="text-container">
              ...
              <p>
                Leno is a HTML landing page template tool. By its nature,
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="text-container last">
                  ...
                  <p>
                    Leno Landing Page uses tracking technology on the landing
                    page, in the Applications, and in the Platforms, including
                    mobile application identifiers and a unique Leno user ID to
                  ...
                  <p>
                    ...
                    By visiting Leno or using the Services you agree to the use
              ...
              <div className="col-md-6">
                <div className="form-container">
                  ...
                  >
                    ...
                    <div className="form-group">
                      <select className="form-control-select" id="pselect" required>
                        <option
                    ...
                    <div className="form-group checkbox">
                      <input
                        ...
                        required
                      />
                      I have read and agree to Leno's
            ...
            <a className="btn-outline-reg back" href="index.html">
              BACK
            </a>
          </div>
        </div>
