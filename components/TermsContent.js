        ...
        <div className="row">
          <div className="col-lg-10 offset-lg-1">
            <div className="text-container">
              ...
              <p>
                Leno also automatically collects and receives certain
              ...
              <p>
                When you first register for a Leno account, and when you use the
              ...
              <ul className="list-unstyled li-space-lg indent">
                ...
                <li className="media">
                  <i className="fas fa-square"></i>
                  <div className="media-body">
                    A unique Leno user ID (an alphanumeric string) which is
            ...
            <div className="text-container">
              ...
              <p>
                Under no circumstances shall Leno be liable for any direct,
                ...
                site, even if Leno or an authorized representative has been
            ...
            <div className="text-container">
              ...
              <p>
                ...
                licensed under the GPL 2.0. Instead, these files inherit Leno
                Personal Use License. These files are given to all Clients on a
                personal use basis. You may not offer them,
                <a className="turquoise" href="#your-link">
                  modified or unmodified
                </a>
                , for redistribution or resale of any kind. You can’t use one of
                our themes on a HTML domain. More on HTML Vs CSS, you can read
                here. You can use our templates do develop sites for your
                clients.
              </p>
              <p>
            ...
            <div className="text-container last">
              ...
              <p>
                Leno Landing Page uses tracking technology on the landing page,
                ...
                improve the Services. By visiting Leno or using the Services you
                ...
                in order to track use of the site and to improve your user
                experience.
              </p>
              <a cNamelass="btn-outline-reg" href="index.html">
                BACK
              </a>
            </div>
          </div>
